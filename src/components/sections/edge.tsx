...
export default function InterdisciplinaryEdge() {
  return (
    <section id="edge" className="py-24 md:py-32 bg-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <SectionReveal direction="left" delay={0.1}>
              <div className="rounded-3xl border border-border bg-white p-6 shadow-card hover:shadow-card-hover transition-all duration-300">
                ...
                <div className="relative pt-2">
                  <svg className="w-full h-10" fill="none" viewBox="0 0 400 40">
                    {/* Background line */}
                    <line x1="20" y1="20" x2="380" y2="20" stroke="#EAEAEA" strokeWidth="2" strokeDasharray="4 4" />
                    {/* Active pathway line */}
                    <motion.line
                      x1="20"
                      y1="20"
                    ...
                    {Array.from({ length: 24 }).map((_, i) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`h-3 w-3 rounded-full ${isActive ? 'bg-accent shadow-glow' : 'bg-foreground'}`}
                        />
                      );
                    })}
                  </div>
              ...
              <div className="rounded-3xl border border-border bg-white p-6 shadow-card hover:shadow-card-hover transition-all duration-300">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="relative w-24 h-24 flex items-center justify-center shrink-0">
                    <div className="absolute inset-0 rounded-full border border-neutral-100 flex items-center justify-center">
                      <div className="w-16 h-16 rounded-full border border-neutral-200/80 flex items-center justify-center">
